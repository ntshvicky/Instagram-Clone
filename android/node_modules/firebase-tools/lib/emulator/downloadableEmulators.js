...
exports.start = exports.downloadIfNecessary = exports.stop = exports.getPID = exports.get = exports.getDownloadDetails = exports.getLogFileName = exports.DownloadDetails = void 0;
...
exports.DownloadDetails = {
    ...
    firestore: {
        ...
        opts: {
            cacheDir: CACHE_DIR,
            remoteUrl: "https://storage.googleapis.com/firebase-preview-drop/emulator/cloud-firestore-emulator-v1.11.12.jar",
    ...
    ui: previews_1.previews.storageemulator
        ? {
            ...
            opts: {
                cacheDir: CACHE_DIR,
                remoteUrl: "https://storage.googleapis.com/firebase-preview-drop/emulator/ui-vStorageSnapshot.zip",
...
const Commands = {
    ...
    storage: {
        binary: "java",
        args: ["-jar", getExecPath(types_1.Emulators.STORAGE), "serve"],
        optionalArgs: [],
        joinArgs: false,
    },
    pubsub: {
